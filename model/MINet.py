...
class MINet(nn.Module):
    ...
    def forward(self, x1, x2):
        ...
        for m1, m2, fusion_conv in zip(self.net1.body._modules.items(), self.net2.body._modules.items(),
                                       self.fusion_convs):
            name1, midlayer1 = m1
            _, midlayer2 = m2
