...
if __name__ == '__main__':
    sp = 'test'
    src_dir = f'/mnt/lijl/HCP/{sp}/'  # BraTs 74:24:24
    tgt_dir = f'/mnt/lijl/Restormer/Dataset/HCP_Multix4/{sp}/'
    visualize_dir = '/mnt/lijl/Restormer/Dataset/HCP_Multix4/visualize'
